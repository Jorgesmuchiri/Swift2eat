                            ...
                            <div class="card-body ">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-14">
                                            <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email', 'admin@lightbp.com') }}" required autocomplete="email">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-14">
                                                <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" value="{{ old('password', 'secret') }}" required autocomplete="current-password">
