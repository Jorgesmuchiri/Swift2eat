    ...
    <main>
                    ...
                    <div class="container">
                        ...
                        <nav>
                            <div class="menu-sec">
                                ...
                                @auth
                                    <a class="log-popup-btn" href="#" itemprop="url"
                                        style="background-color: orange;">{{ auth()->user()->name }}</a>
        ...
        <div class="responsive-header">
            ...
            <div class="responsive-logomenu">
                <div class="logo">
                    <h1 itemprop="headline"><a href="index-2.html" title="Home" itemprop="url"><img
                        ...
                        <div class="row pt-3">
                            ...
                            <div class="col-sm-8">
                                <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                    <input class="input-field brd-rd2{{ $errors->has('name') ? ' is-invalid' : '' }}"
                                        name="phonenumber" id="phone_number" type="text"
                                        placeholder="{{ __('2547') }}" value=" {{ Auth::user()->phone_number }} "
        ...
        <script type="text/javascript">
            ...
            document.getElementById("checkoutOrder").addEventListener("click", function(event) {
                ...
                //             headers
                //         })
                //     let jsonResponse = await token.json()
                //     return jsonResponse
                // }
                // const accessToken = async () => {
                //     let jsonData = await getAccessToken();
                ...
                // headers.append("Authorization", "Bearer yBowD7acQ3lAsuZVdMGhuvEWeVYH");
                ...
                //             "Password": btoa("174379FTaotwjNTGNTydc4pgG74BOZ6Pa42qwU" + timeStamp),
                //             "Timestamp": timeStamp,
                //             "TransactionType": "CustomerBuyGoodsOnline",
                //             "amount": "1",
                //             "PartyA": "254748335870",
                //             "PartyB": "174379",
                //             "PhoneNumber": "254748335870",
