...
<head>
    <meta charset="UTF-8">
    <meta name="viewport"
        content="width=device-width, maximum-scale=1, shrink-to-fit=no, initial-scale=1, shrink-to-fit=no">
    <meta name="description" content="Swyft2eat: Why wait when you can order?" />
    <meta name="keywords"
        content="Swyft2eat, Swyft2eat.co.ke, Swyft, food, food delivery, 
    ...
    <main>
                ...
                <div class="container">
                    <div class="logo">
                        <h1 itemprop="headline"><a href="{{ url('/') }}" title="Home" itemprop="url"><img
                                    src="/assets/images/logo5.png" alt="logo.png" itemprop="image"
            ...
            <div class="block blackish opac50">
                ...
                <div class="restaurant-searching style2 text-center">
                    <div class="restaurant-searching-inner">
                        ...
                        <h2 itemprop="headline">Why wait when you can order</h2>
                        ...
                        <div class="welcome-sec">
                            <div class="col-md-6 col-sm-6 col-lg-6">
                                <div class="welcome-secinfo">
                                    ...
                                    <p>Everyone in the restaurant space these days is accepting restaurant delivery
                                        orders. Struck with high rentals and poor sales, many restaurants are now even
                                        making food delivery as their primary business model and turning into cloud
                                        kitchens. With such top competition, you need to ensure that you are ahead of
                                        your competition.</p>
                                    <div class="award">
                            ...
                            <div class="col-md-6 col-sm-6 col-lg-6">
                                <div class="welcome-gallery">
                                    <img src="https://images.unsplash.com/photo-1644677865374-1e16ac9b3253?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1171&q=80"
                                        alt="" width="450px">
                                </div>
                            </div>
                        </div>
        ...
        <section>
            <div class="block blackish low-opacity">
                <div class="fixed-bg"
                    style="background-image: url(https://images.unsplash.com/photo-1644677867331-03f28942e35c?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80);">
                </div>
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-lg-12">
                                ...
                                <div class="row">
                                    <div class="col-md-4 col-sm-4 col-lg-4">
                                        <div class="step-box wow fadeIn" data-wow-delay="0.2s">
                                            <i><img src="assets/images/resource/setp-img1.png" alt="setp-img1.png"
                                    ...
                                    <div class="col-md-4 col-sm-4 col-lg-4">
                                        <div class="step-box wow fadeIn" data-wow-delay="0.4s">
                                            <i><img src="assets/images/resource/setp-img2.png" alt="setp-img2.png"
                                    ...
                                    <div class="col-md-4 col-sm-4 col-lg-4">
                                        <div class="step-box wow fadeIn" data-wow-delay="0.6s">
                                            <i><img src="assets/images/resource/setp-img3.png" alt="setp-img3.png"
                                            ...
                                            <div class="popular-dish-box style2 wow fadeIn" data-wow-delay="0.2s">
                                                <div class="popular-dish-thumb">
                                                    <a href="{{ route('restaurant-detail', $vendor->id) }}"
                                                        title="" itemprop="url"><img
                                                            src="assets/images/vendors/{{ $vendor->vendor_logo }}"
                                                ...
                                                <div class="popular-dish-info">
                                                    <h4 itemprop="headline"><a
                                                            ...
                                                            title=""
                                                            itemprop="url">{{ $vendor->vendor_name }}</a></h4>
                                                    <!-- <p itemprop="description">Lorem Ipsum is simply dummy text of the printing and typesetting industry</p> -->
                                                    ...
                                                    <div class="restaurant-info">
                                                        ...
                                                        <div class="restaurant-info-inner">
                                                            <h6 itemprop="headline"><a
                                                                    href="{{ route('restaurant-detail', $vendor->id) }}"
                                                                    title="" itemprop="url"></a></h6>
                                                            <span
                                                                class="orange-clr">Location::{{ $vendor->location }}</span><br>
                                                            <span class="orange-clr">Contact
                                                                Us:{{ $vendor->phone_no }}</span>
                                                        </div>
                                                    </div>
                                                </div>
        ...
        <section>
            <div class="block no-padding orange-bg">
                <img class="bottom-clouds-mockup" src="assets/images/resource/clouds2.png" alt="clouds2.png"
                    itemprop="image">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-lg-12">
                                ...
                                <div class="row">
                                    <div
                                        ...
                                        <div class="app-mockup text-right overlape-110 wow fadeInUp"
                                            data-wow-delay="0.2s"><img src="assets/images/resource/mockup-bg.png"
                                    ...
                                    <div
                                        ...
                                        <div class="app-info">
                                            ...
                                            <p itemprop="description">With a great variety of restaurants you can order
                                                your favourite food or explore new restaurants nearby!</p>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-sm-6 col-lg-3">
                                        <div class="widget get_in_touch wow fadeIn" data-wow-delay="0.4s">
                                            ...
                                            <ul>
                                                <li><i class="fa fa-map-marker" style="color: orange;"></i> Nairobi,
                                                    Kenya</li>
                                                <li><i class="fa fa-phone" style="color: orange;"></i> +254 711 281774
                                                    | +254 797 309416</li>
                                                <li><i class="fa fa-envelope" style="color: orange;"></i> <a
                                                        href="#" title=""
        ...
        <div class="log-popup text-center">
            <div class="sign-popup-wrapper brd-rd5">
                <div class="sign-popup-inner brd-rd5">
                    ...
                    <form method="post" class="sign-form" action="{{ route('login') }}" autocomplete="off"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-sm-12 col-lg-12">
                                ...
                                <a class="recover-btn" href="{{ route('forget_password') }}" title=""
